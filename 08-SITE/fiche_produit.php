...
// afficher deux produits (photo et titre ) aléatoirement appartenant à la catégorie du produit affiché au dessus. Ces deux produits doivent etre différents du produit consulté . La photo doit etre cliquable et mène à la fiche détaillé du produit.Vous utiliserez la variable $suggestion pour afficher le contenu
...
while ($produit_suggere = $resultat->fetch(PDO::FETCH_ASSOC)) {
   ...
   $suggestion .= '<div class="col-sm-3">';// le .= permet de concaténer les valeurs à chaque tour de boucle sans remplacer la valeur précedente.
        ...
        $suggestion .= '<a href="?id_produit='.$produit_suggere['id_produit'].'">
                        ...
                        </a>'; // pour afficher le détail du produit, on ajoute un lien en $_get qui envoie l'id_produit à la page fiche_produit.php
